                                ...
                                <div className="panel-footer">
                                    <div className="row">
                                        <div className="col-md-6 nopadding">
                                            ...
                                            <label type="button" className="btn btn-blue-grey pull-left" name="button"> Upload IMG <input type="file" style="display: none;" /></label>
                                        </div>
                                        <div className="col-md-6 nopadding">
